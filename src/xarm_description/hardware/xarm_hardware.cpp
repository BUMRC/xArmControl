...
namespace xarm_hardware
{
        ...
        const hardware_interface::HardwareInfo &info)
    {
        ...
        joints = {
            Joint("xarm_6_joint", 2048),
            Joint("xarm_5_joint", 2048),
            Joint("xarm_4_joint", 2048),
            Joint("xarm_3_joint", 2048),
            Joint("xarm_2_joint", 2048),
        };
    ...
    std::vector<hardware_interface::CommandInterface> XArmSystemHardware::export_command_interfaces()
    {
        ...
        for (auto i = 0u; i < joints.size(); i++)
        {
            command_interfaces.emplace_back(hardware_interface::CommandInterface(
                joints[i].name, hardware_interface::HW_IF_VELOCITY, &joints[i].cmd));
        }
